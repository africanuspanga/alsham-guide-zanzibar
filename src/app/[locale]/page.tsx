    ...
    <>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-5xl font-black text-brand-blue-dark mb-3">
              {locale === "fr" ? "Activités Nautiques" : "Water Activities"}
            </h2>
            <p className="text-brand-gold font-bold text-lg">
              {locale === "fr"
                ? "Jet Ski, Car Ski & plus — sensations fortes sur l'eau"
                : "Jet Ski, Car Ski & more — thrilling water adventures"}
            </p>
          </div>
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
            {locale === "fr"
              ? "Sentez l'adrénaline monter avec nos activités nautiques passionnantes à Zanzibar ! Que vous rêviez de dominer les vagues sur un jet ski puissant, de conduire notre célèbre voiture jaune sur l'eau, ou simplement de profiter du soleil tropical sur l'océan Indien — nous avons l'aventure parfaite pour vous."
              : "Feel the adrenaline rush with our exciting water activities in Zanzibar! Whether you dream of conquering the waves on a powerful jet ski, driving our famous yellow car on water, or simply enjoying the tropical sun on the Indian Ocean — we have the perfect adventure for you."}
          </p>

          {/* Image Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            {/* Featured large image */}
            <div className="sm:col-span-2 lg:col-span-1 lg:row-span-2 relative h-72 sm:h-96 lg:h-full rounded-3xl overflow-hidden group">
              <Image
                src="/images/water-activity-1.jpeg"
                alt={locale === "fr" ? "Voiture jaune sur l'eau" : "Yellow car boat on water"}
                fill
                className="object-cover group-hover:scale-105 transition-transform duration-500"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <span className="inline-block bg-brand-gold text-white text-xs font-black px-4 py-1.5 rounded-full uppercase tracking-wide mb-2">
                  {locale === "fr" ? "Populaire" : "Popular"}
                </span>
                <h3 className="text-white font-black text-xl">
                  {locale === "fr" ? "Car Ski Jaune" : "Yellow Car Ski"}
                </h3>
              </div>
            </div>
            ...
            <div className="relative h-64 rounded-3xl overflow-hidden group">
              <Image
                src="/images/water-activity-3.jpeg"
                alt={locale === "fr" ? "Jet ski avec célébration" : "Jet ski with celebration"}
                fill
                className="object-cover group-hover:scale-105 transition-transform duration-500"
                sizes="(max-width: 640px) 100vw, 50vw"
              />
            ...
            <div className="relative h-64 rounded-3xl overflow-hidden group">
              <Image
                src="/images/water-activity-4.jpeg"
                alt={locale === "fr" ? "Jet ski vue du dessus" : "Jet ski top view"}
                fill
                className="object-cover group-hover:scale-105 transition-transform duration-500"
                sizes="(max-width: 640px) 100vw, 50vw"
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <h3 className="text-white font-black text-lg">
                  {locale === "fr" ? "Aventure en Mer" : "Sea Adventure"}
                </h3>
              </div>
            </div>

            {/* Third row - full width on mobile, span 2 on larger */}
            <div className="sm:col-span-2 relative h-64 rounded-3xl overflow-hidden group">
              <Image
                src="/images/water-activity-2.jpeg"
                alt={locale === "fr" ? "Voiture jaune sur la plage" : "Yellow car boat on beach"}
                fill
                className="object-cover group-hover:scale-105 transition-transform duration-500"
                sizes="100vw"
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div className="bg-brand-blue-dark rounded-2xl p-6">
              <div className="text-brand-gold text-4xl font-black mb-2 text-center">100€</div>
              <p className="text-white font-bold mb-1 text-center">
                {locale === "fr" ? "Car Jet — Kendwa Beach" : "Car Jet — Kendwa Beach"}
              </p>
              <div className="text-brand-sky text-sm text-center mb-3">
                {locale === "fr" ? "20 minutes · 1 Car Jet" : "20 minutes · 1 Car Jet"}
              </div>
              <ul className="text-gray-300 text-sm space-y-1">
                <li className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-brand-gold"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                  {locale === "fr" ? "Inclus : 20 minutes" : "Include : 20 minutes"}
                </li>
                <li className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-brand-gold"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                  {locale === "fr" ? "1 Car Jet" : "1 Car Jet"}
                </li>
              </ul>
            </div>
            <div className="bg-brand-blue-dark rounded-2xl p-6">
              <div className="text-brand-gold text-4xl font-black mb-2 text-center">55€</div>
              <p className="text-white font-bold mb-1 text-center">
                {locale === "fr" ? "Jet Ski — Kendwa Beach" : "Jet Ski — Kendwa Beach"}
              </p>
              <div className="text-brand-sky text-sm text-center mb-3">
                {locale === "fr" ? "30 minutes · 1 Jet Ski" : "30 minutes · 1 Jet Ski"}
              </div>
              <ul className="text-gray-300 text-sm space-y-1">
                <li className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-brand-gold"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                  {locale === "fr" ? "Inclus : 30 minutes" : "Include : 30 minutes"}
                </li>
                <li className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-brand-gold"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                  {locale === "fr" ? "1 Jet Ski" : "1 Jet Ski"}
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-500 mb-6 text-sm">
              {locale === "fr"
                ? "Disponible 7j/7 — Réservez dès maintenant par WhatsApp"
                : "Available 7 days a week — Book now via WhatsApp"}
            </p>
            <a
              href="https://wa.me/255777596239?text=Bonjour%20AlSham%20Tours!%20Je%20souhaite%20réserver%20une%20activité%20nautique"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 bg-brand-gold hover:bg-brand-gold-light text-white font-black px-10 py-5 rounded-full text-lg transition-all hover:scale-105 shadow-2xl shadow-brand-gold/30"
            >
