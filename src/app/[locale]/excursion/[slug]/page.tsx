          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4 text-white/80">
              <span className="flex items-center gap-1">
                ...
                €{tour.price} / {locale === "fr" ? "personne" : "person"}
              </span>
              <span className="flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="sticky top-32 space-y-6">
              {/* Pricing Card */}
              <div className="bg-white border-2 border-brand-blue/20 rounded-2xl p-6 shadow-lg">
      ...
      <section className="bg-brand-blue-dark py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
            {locale === "fr" ? (
              <>Réservez votre <span className="text-brand-gold">excursion</span> maintenant</>
            ) : (
              <>Book your <span className="text-brand-gold">excursion</span> now</>
            )}
          </h2>
          <p className="text-brand-sky text-xl mb-10 max-w-2xl mx-auto">
            {locale === "fr" 
              ? "Contactez-nous dès maintenant pour réserver votre place et vivre une expérience inoubliable à Zanzibar."
              : "Contact us now to book your spot and experience an unforgettable adventure in Zanzibar."}
          </p>
